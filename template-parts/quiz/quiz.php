        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="section-title-wrapper text-center">
                    <h2 class="section-title">Узнайте примерную стоимость вашей мебели</h2>
                    <p class="section-subtitle">Ответьте на 8 коротких вопросов</p>
                ...
                <div class="quiz-question-container">
                    <div class="row text-start quiz-question-wrapper">
                        ...
                        <!-- question-1 -->
                        <div class="col" id="question-1">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>1/8</span> Какой предмет мебели Вас интересует?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-1-1">
                                        <input type="radio" id="answer-1-1" name="question-1" class="checkbox" value="Кухня" />
                                    ...
                                    <h6 class="quiz-section-h3 mb-4">Кухня</h6>
                                </div>

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-1-2">
                                        <input type="radio" id="answer-1-2" name="question-1" class="checkbox" value="Шкаф" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                    ...
                                    <h6 class="quiz-section-h3 mb-4">Шкаф</h6>
                                </div>

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-1-3">
                                        <input type="radio" id="answer-1-3" name="question-1" class="checkbox" value="Другой" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                    ...
                                    <h6 class="quiz-section-h3 mb-4">Другой</h6>
                                </div>
                            </div>
                        ...
                        <div class="col" id="question-2-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>2/8</span> Какая планировка кухни Вам нужна?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-kitchen-1">
                                        <input type="radio" id="answer-2-kitchen-1" name="question-2-kitchen" class="checkbox" value="Прямая" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-kitchen-2">
                                        <input type="radio" id="answer-2-kitchen-2" name="question-2-kitchen" class="checkbox" value="Угловая" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-kitchen-3">
                                        <input type="radio" id="answer-2-kitchen-3" name="question-2-kitchen" class="checkbox" value="П-образная" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="14" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col" id="question-3-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>3/8</span> Какие дополнительные особенности кухни Вы хотите?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-kitchen-1">
                                        <input type="checkbox" id="answer-3-kitchen-1" name="answer-3-kitchen-1" class="checkbox" value="Барная стойка" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-kitchen-2">
                                        <input type="checkbox" id="answer-3-kitchen-2" name="answer-3-kitchen-2" class="checkbox" value="Островок" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-kitchen-3">
                                        <input type="checkbox" id="answer-3-kitchen-3" name="answer-3-kitchen-3" class="checkbox" value="Высота до потолка" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col" id="question-4-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/8</span> Введите размеры кухни</h3>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="42" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col" id="question-5-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/8</span> Какой стиль кухни Вы рассматриваете?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-kitchen-1">
                                        <input type="radio" id="answer-5-kitchen-1" name="question-5-kitchen" class="checkbox" value="Современный" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-kitchen-2">
                                        <input type="radio" id="answer-5-kitchen-2" name="question-5-kitchen" class="checkbox" value="Классический" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-kitchen-3">
                                        <input type="radio" id="answer-5-kitchen-3" name="question-5-kitchen" class="checkbox" value="Лофт" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-5-kitchen-4">
                                        <input type="radio" id="answer-5-kitchen-4" name="question-5-kitchen" class="checkbox" value="Пока не знаю (нужна консультация)" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="56" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col" id="question-6-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>6/8</span> Какой материал фасада Вы рассматриваете?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-1">
                                        <input type="radio" id="answer-6-kitchen-1" name="question-6-kitchen" class="checkbox" value="ЛДСП" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-2">
                                        <input type="radio" id="answer-6-kitchen-2" name="question-6-kitchen" class="checkbox" value="МДФ" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-3">
                                        <input type="radio" id="answer-6-kitchen-3" name="question-6-kitchen" class="checkbox" value="Эмаль" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-4">
                                        <input type="radio" id="answer-6-kitchen-4" name="question-6-kitchen" class="checkbox" value="Шпон" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-5">
                                        <input type="radio" id="answer-6-kitchen-5" name="question-6-kitchen" class="checkbox" value="Пластик" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-6">
                                        <input type="radio" id="answer-6-kitchen-6" name="question-6-kitchen" class="checkbox" value="AGT" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-7">
                                        <input type="radio" id="answer-6-kitchen-7" name="question-6-kitchen" class="checkbox" value="Массив" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-6-kitchen-8">
                                        <input type="radio" id="answer-6-kitchen-8" name="question-6-kitchen" class="checkbox" value="Пока не знаю (нужна консультация)" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <!-- question-6-5-kitchen -->
                        <div class="col" id="question-6-5-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>7/8</span> Какой бюджет Вы планируете?</h3>

                            <div class="row quiz-questions-container d-flex flex-column">

                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-kitchen-1">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-kitchen-1" name="question-6-5-kitchen" class="checkbox" value="150 — 200 тыс. руб." />
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-kitchen-2">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-kitchen-2" name="question-6-5-kitchen" class="checkbox" value="200 — 300 тыс. руб." />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-kitchen-3">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-kitchen-3" name="question-6-5-kitchen" class="checkbox" value="более 300 тыс. руб." />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-kitchen-4">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-kitchen-4" name="question-6-5-kitchen" class="checkbox" value="не определился" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-lg-5 mb-3 mb-lg-0">
                                    <div class="progress" role="progressbar" aria-label="Progress" aria-valuenow="84" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <div class="col" id="question-7-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>8/8</span> Какой подарок Вы хотите получить в случае заказа?</h3>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-kitchen-1">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/7-kitchen-1.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-kitchen-2">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/7-kitchen-2.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-kitchen-3">
                                        ...
                                        <div class="option_inner">
                                            ...
                                            <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/img/7-kitchen-3.webp"
                                                style="width: 100%" />
                                        </div>
                                    </label>
                        ...
                        <div class="col" id="question-2-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>2/8</span> Какой тип шкафа Вам нужен?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-wardrobe-1">
                                        <input type="radio" id="answer-2-wardrobe-1" name="question-2-wardrobe" class="checkbox" value="Встроенный" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-wardrobe-2">
                                        <input type="radio" id="answer-2-wardrobe-2" name="question-2-wardrobe" class="checkbox" value="Корпусный" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-2-wardrobe-3">
                                        <input type="radio" id="answer-2-wardrobe-3" name="question-2-wardrobe" class="checkbox" value="Гардеробный" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                        ...
                        <div class="col" id="question-3-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>3/8</span> Какого типа двери Вы хотите?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-wardrobe-1">
                                        <input type="radio" id="answer-3-wardrobe-1" name="question-3-wardrobe" class="checkbox" value="Купе" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-wardrobe-2">
                                        <input type="radio" id="answer-3-wardrobe-2" name="question-3-wardrobe" class="checkbox" value="Распашные" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-3-wardrobe-3">
                                        <input type="radio" id="answer-3-wardrobe-3" name="question-3-wardrobe" class="checkbox" value="Радиусные" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                        ...
                        <div class="col" id="question-4-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/8</span> Какой материал фасада Вы хотите?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-4-wardrobe-1">
                                        <input type="radio" id="answer-4-wardrobe-1" name="question-4-wardrobe" class="checkbox" value="ЛДСП" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-4-wardrobe-2">
                                        <input type="radio" id="answer-4-wardrobe-2" name="question-4-wardrobe" class="checkbox" value="Пескоструй" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-4-wardrobe-3">
                                        <input type="radio" id="answer-4-wardrobe-3" name="question-4-wardrobe" class="checkbox" value="Зеркало" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-4-wardrobe-4">
                                        <input type="radio" id="answer-4-wardrobe-4" name="question-4-wardrobe" class="checkbox" value="Комбинированный" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-4-wardrobe-5">
                                        <input type="radio" id="answer-4-wardrobe-5" name="question-4-wardrobe" class="checkbox" value="Пока не знаю (нужна консультация)" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                        ...
                        <div class="col" id="question-5-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/8</span> Какая ориентировочная ширина шкафа планируется?</h3>
                            ...
                            <div class="row quiz-questions-container">
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-1">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-1" name="answer-5-wardrobe-1" class="checkbox" value="1м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-2">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-2" name="answer-5-wardrobe-2" class="checkbox" value="1,5м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-3">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-3" name="answer-5-wardrobe-3" class="checkbox" value="2м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-4">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-4" name="answer-5-wardrobe-4" class="checkbox" value="2,5м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-5">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-5" name="answer-5-wardrobe-5" class="checkbox" value="3м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-6">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-6" name="answer-5-wardrobe-6" class="checkbox" value="3,5м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-7">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-7" name="answer-5-wardrobe-7" class="checkbox" value="4м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-8">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-8" name="answer-5-wardrobe-8" class="checkbox" value="4,5м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-9">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-9" name="answer-5-wardrobe-9" class="checkbox" value="5м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-5-wardrobe-10">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-5-wardrobe-10" name="answer-5-wardrobe-10" class="checkbox" value="Более 5 м" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                        ...
                        <div class="col" id="question-6-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>6/8</span> Какое количество дверей Вы предполагаете?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-1">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-1" name="answer-6-wardrobe-1" class="checkbox" value="1" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-2">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-2" name="answer-6-wardrobe-2" class="checkbox" value="2" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-3">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-3" name="answer-6-wardrobe-3" class="checkbox" value="3" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-4">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-4" name="answer-6-wardrobe-4" class="checkbox" value="4" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-5">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-5" name="answer-6-wardrobe-5" class="checkbox" value="5" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-3">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-wardrobe-6">
                                        <div class="option_item">
                                            <input type="checkbox" id="answer-6-wardrobe-6" name="answer-6-wardrobe-6" class="checkbox" value="Более 5" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                        ...
                        <!-- question-6-5-wardrobe -->
                        <div class="col" id="question-6-5-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>7/8</span> Какой бюджет Вы планируете?</h3>

                            <div class="row quiz-questions-container d-flex flex-column">

                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-wardrobe-1">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-wardrobe-1" name="question-6-5-wardrobe" class="checkbox" value="75 — 100 тыс. руб." />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-wardrobe-2">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-wardrobe-2" name="question-6-5-wardrobe" class="checkbox" value="100 — 150 тыс. руб." />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-wardrobe-3">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-wardrobe-3" name="question-6-5-wardrobe" class="checkbox" value="более 150 тыс. руб." />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                                ...
                                <div class="col-12 col-md-8">
                                    <label class="d-flex quiz-chek gap-3" for="answer-6-5-wardrobe-4">
                                        <div class="option_item">
                                            <input type="radio" id="answer-6-5-wardrobe-4" name="question-6-5-wardrobe" class="checkbox" value="не определился" />
                                            <div class="option_inner text-start">
                                                <div class="shadow-wrapper-box"></div>
                                                <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/ico/checkbox.svg" />
                                            </div>
                        ...
                        <!-- question-7-wardrobe -->
                        <div class="col" id="question-7-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>8/8</span> Какой подарок Вы хотите получить в случае заказа?</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-wardrobe-1">
                                        <input type="radio" id="answer-7-wardrobe-1" name="question-7-wardrobe" class="checkbox" value="Дополнительная скидка 10%" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-wardrobe-2">
                                        <input type="radio" id="answer-7-wardrobe-2" name="question-7-wardrobe" class="checkbox" value="Беспроцентная рассрочка на 6 месяцев" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                                ...
                                <div class="col-6 col-sm-4 col-xl-3">
                                    <label class="option_item mb-3" for="answer-7-wardrobe-3">
                                        <input type="radio" id="answer-7-wardrobe-3" name="question-7-wardrobe" class="checkbox" value="Скидка 15% на заказ шкафа в течение года" />
                                        <div class="option_inner">
                                            <div class="shadow-wrapper">
                                                <div class="shadow-wrapper-decoration"></div>
                                            </div>
                        ...
                        <!-- question-2-other -->
                        <div class="col" id="question-2-other" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>8/8</span> Для расчета опишите Ваше изделие</h3>

                            <div class="row quiz-questions-container">

                                <div class="col-12">
                                    <textarea type="text" rows="3" name="question-2-other-description" class="form-control" placeholder="Опишите изделие своими словами, укажите размеры, материалы и другую информацию" style="height: auto; margin-top: 15px; margin-bottom: 15px;"></textarea>
                        ...
                        <div class="col" id="question-final" style="display: none">
                            ...
                            <form action="<?php echo get_stylesheet_directory_uri(); ?>/template-parts/quiz/mails/quiz.php" id="quiz" enctype="multipart/form-data" method="post" name="quiz" class="form">
                                ...
                                <input type="hidden" id="form-question-1" name="form-question-1" />
                                <input type="hidden" id="form-question-2-kitchen" name="form-question-2-kitchen" />
                                <input type="hidden" id="form-answer-3-kitchen-1" name="form-answer-3-kitchen-1" />
                                <input type="hidden" id="form-answer-3-kitchen-2" name="form-answer-3-kitchen-2" />
                                <input type="hidden" id="form-answer-3-kitchen-3" name="form-answer-3-kitchen-3" />
                                ...
                                <input type="hidden" id="form-question-4-wardrobe" name="form-question-4-wardrobe" />
                                ...
                                <input type="hidden" id="form-question-6-5-kitchen" name="form-question-6-5-kitchen" />
                                <input type="hidden" id="form-answer-5-wardrobe-7" name="form-answer-5-wardrobe-7" />
                                <input type="hidden" id="form-answer-5-wardrobe-8" name="form-answer-5-wardrobe-8" />
                                <input type="hidden" id="form-answer-5-wardrobe-9" name="form-answer-5-wardrobe-9" />
                                <input type="hidden" id="form-answer-5-wardrobe-10" name="form-answer-5-wardrobe-10" />
                                <input type="hidden" id="form-answer-6-wardrobe-1" name="form-answer-6-wardrobe-1" />
                                <input type="hidden" id="form-answer-6-wardrobe-2" name="form-answer-6-wardrobe-2" />
                                <input type="hidden" id="form-answer-6-wardrobe-3" name="form-answer-6-wardrobe-3" />
                                <input type="hidden" id="form-answer-6-wardrobe-4" name="form-answer-6-wardrobe-4" />
                                <input type="hidden" id="form-answer-6-wardrobe-5" name="form-answer-6-wardrobe-5" />
                                <input type="hidden" id="form-answer-6-wardrobe-6" name="form-answer-6-wardrobe-6" />
                                <input type="hidden" id="form-question-6-5-wardrobe" name="form-question-6-5-wardrobe" />
                                <input type="hidden" id="form-question-7-wardrobe" name="form-question-7-wardrobe" />
                                <input type="hidden" id="form-question-2-other-description" name="form-question-2-other-description" />
