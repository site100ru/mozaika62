...
<section class="main-home-section">
	<div class="parallax-home-section-portfolio" style="min-height: 640px;"></div>
...
<section class="archive-portfolio-section-2 py-5 bg-white">
	<div class="container">
		...
		<div class="row text-md-center">
			<div class="col">
				<a href="https://мозаика62.рф/portfolio-cat/01-кухни/" type="button" class="btn btn-lg btn-corporate-color-1">Показать еще</a>
			</div>
		</div>
	</div>
</section>				
