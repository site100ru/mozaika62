            ...
            <div class="col-md-6 mb-5">
                <a href="https://мозаика62.рф/кухни-на-заказ/">
                    <div class="approximation project-container-2 services">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/kitchen.webp" class="img-fluid" alt="">
            ...
            <div class="col-md-6 mb-5">
                <a href="https://мозаика62.рф/шкафы-на-заказ/">
                    <div class="services approximation project-container-2">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/wardrobe.webp" class="img-fluid" alt="" decoding="async" />
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
        ...
        <div class="row text-start">
            <div class="col-md-6 mb-5">
                <a href="https://мозаика62.рф/product-category/кухни/">
                    <div class="approximation project-container-2 services">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/card1.webp" class="img-fluid" alt="">
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
            ...
            <div class="col-md-6 mb-5">
                <a href="https://мозаика62.рф/product-category/шкафы/">
                    <div class="services approximation project-container-2">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/closet-2-4.webp" class="img-fluid" alt="" decoding="async" />
                        <div class="card-wrapper project-container-2-footer">
                            <div class="row" style="height: 100%;">
                                <div class="col-6">
...
<section class="gradient-order-section bg-white" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/sec-bg3.webp);">
    <div class="container">
